...
```
## Motor de aficionado
#### Aclaración: El motor en las partes 2 y 3 lo agregué posteriormente a la fecha de parcial porque malinterpreté el enunciado. Poseé la misma función con el que fue presentado en la parte 4. Se activa cuando el sensor de temperatura detecta valores superiores a los 50 grados.
